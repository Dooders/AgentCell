...
for glucose in glucose_amounts:
    ...
    reporter.log_event(f"2-Phosphoglycerate remaining: {cell.metabolites['phosphoglycerate_2'].quantity}")
    reporter.log_event(f"Phosphoenolpyruvate produced: {cell.metabolites['phosphoenolpyruvate'].quantity}")
